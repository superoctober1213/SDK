...
import com.example.sdk.Interface.M70cdata;
        ...
        if (head.equals("AA") & data.length() > 4) {
            ...
            if (dataID.equals("41")) {
                ...
                if (!isFirstReceive) {
                    ...
                    int SPO2Value = Integer.parseInt(receivedData.substring(72, 74), 16) & 0x7F;//����Ϊ�˸�λ����
                    Log.e("spo2  valuue", "" +SPO2Value );
                    onM70cDataListener.setSPO2Value(SPO2Value);
//                    if (SPO2Value == 127) {//�������127�Ǿ�˵�������˷�Χ��
...
//                    }
                    ...
                    Log.e("heartRateValue  valuue", "" +heartRateValue);

                    onM70cDataListener.setHeartRateValue(heartRateValue);
                    for (int i = 0; i < 30; i++) {
//                        Log.e("receivedData.substring(10 + i * 2, 12 + i * 2)","��"+i+""+receivedData.substring(10 + i * 2, 12 + i * 2));
                        int PIValue = Integer.parseInt(receivedData.substring(10 + i * 2, 12 + i * 2), 16);
//                        Log.e("PIvaule","��"+i+""+PIValue);
...
////                                    msg.obj = oximet;
////                                    config.getMainHandler2().sendMessage(msg);//�����̷߳���message
//                    }
                                /* �������ļ��� */
//                    if (isSdCardExist()) {
//                        try {
...
//                }
            ...
            Log.e("to see the final receivedData", "" + receivedData);
        }
    }
}
