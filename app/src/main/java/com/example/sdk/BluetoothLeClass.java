...
import com.example.sdk.entity.ConnectBleServiceInfo;
import com.example.sdk.entity.Constant;
...
public class BluetoothLeClass{
    ...
    public final static String ACTION_GATT_CONNECTED = "com.example.sdk.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.example.sdk.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.example.sdk.ACTION_GATT_SERVICES_DISCOVERED ";
    public final static String ACTION_DATA_AVAILABLE = "com.example.sdk.ACTION_DATA_AVAILABLE";
    public final static String ACTION_FAIL_TO_CONNECTED = "com.example.sdk.ACTION_FAIL_TO_CONNECTED";
    public final static String EXTRA_DATA_B = "com.example.sdk.EXTRA_DATA_BYTE";
    public final static String EXTRA_DATA_W = "com.example.sdk.EXTRA_DATA_WEIGHT";
    ...
    private void setLeScanCallback(){
        ...
        mLeScanCallback= new BluetoothAdapter.LeScanCallback() {
            ...
            public void onLeScan(final BluetoothDevice device, int rssi, final byte[] scanRecord) {
                Log.e("device.scanRecord",scanRecord.toString());
    ...
    public void setBluetoothGattCallback() {
        mGattCallback = new BluetoothGattCallback() {
            ...
            public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState) {
                String intentAction;
                Log.e(TAG, "onConnectionStateChange:-change--");
...
//                    broadcastUpdate(intentAction);
            ...
            public void onServicesDiscovered(BluetoothGatt gatt, int status) {
                ...
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    ...
                    Log.e(TAG, "onServicesDiscovered exception hanppen: " + status);
                }
            }
...
//                    broadcastUpdate(ACTION_DATA_AVAILABLE, characteristic);
            ...
            public void onDescriptorWrite(BluetoothGatt gatt, BluetoothGattDescriptor descriptor, int status) {
                ...
                if (status == BluetoothGatt.GATT_SUCCESS) {
                    Log.e(TAG, "Callback: Wrote GATT Descriptor successfully. " + "descriptor:" + descriptor.getCharacteristic().getUuid());
                } else {
                    Log.e(TAG, "Callback: Error writing GATT Descriptor: " + status + ", descriptor:" + descriptor.getCharacteristic().getUuid());
                }
            }
        };
    }
    ...
    public boolean initialize() {
        ...
        // BluetoothManager.
        config=(Config)mContext.getApplicationContext();
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic, boolean enabled, ConnectBleServiceInfo serviceInfo) {
        ...
        Log.e("tets", "notification success??::::::" + flv);
